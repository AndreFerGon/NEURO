...
'''
Este script é executado a partir do terminal de forma a definir os elétrodos onde se quer adquirir o EEG
...
params.serial_port = 'COM6' # Porta COM do BT dongle no PC
