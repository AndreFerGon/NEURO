...
def main():
    ...
    squares_info = [
        {"rect": pygame.Rect(250, 100, 300, 300), "num_rows": 8, "num_cols": 8, "toggle_interval": toggle_frame_interval_1},
        {"rect": pygame.Rect(250, 600, 300, 300), "num_rows": 8, "num_cols": 8, "toggle_interval": toggle_frame_interval_2},
        {"rect": pygame.Rect(1050, 100, 300, 300), "num_rows": 8, "num_cols": 8, "toggle_interval": toggle_frame_interval_3},
        {"rect": pygame.Rect(1050, 600, 300, 300), "num_rows": 8, "num_cols": 8, "toggle_interval": toggle_frame_interval_4}
    ]
